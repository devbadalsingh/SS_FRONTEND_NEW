...
import { useESignPendingQuery, usePendingSanctionsQuery } from '../../Service/applicationQueries';
...
const PendingESign = () => {
  ...
  const { data: allApplication,isSuccess:applicationSuccess, refetch } = useESignPendingQuery({page:paginationModel.page+1,limit:paginationModel.pageSize})
