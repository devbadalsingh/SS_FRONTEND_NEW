...
const SanctionProfile = () => {
    ...
    const { data, isSuccess, isError, error } = useSanctionProfileQuery(id, {
        skip: id === null,
    });
    const [
        sanctionPreview,
    ...
    useEffect(() => {
        ...
        if (isSuccess && data?.application?.lead?.document?.length) {
            setUploadedDocs(
                data?.application?.lead?.document.map((doc) => doc.type)
            );
        }
    }, [isSuccess, data]);
                            ...
                            <>
                                ...
                                >
                                    <ApplicantProfileData
                                        leadData={data?.application?.lead}
                                        loanNo={data?.loanNo}
                                    />
                                </Paper>
