            ...
            ? [
                  {
                      ...
                      value: applicationProfile?.disbursal?.payableAccount,
                  },
                  {
                      label: "Disbursed On",
                      value:
                          applicationProfile?.disbursal?.disbursedBy &&
                          formatDate(
                              applicationProfile?.disbursal?.disbursedAt
                          ),
                  },
                  {
                      label: "Disbursed By",
                      value: `${
                          applicationProfile?.disbursal?.disbursedBy?.fName
                      }${
                          applicationProfile?.disbursal?.disbursedBy?.lName
                              ? ` ${applicationProfile?.disbursal?.disbursedBy?.lName}`
                              : ``
                      }`,
                  },
                  {
                      ...
                      value: applicationProfile?.disbursal?.amount,
                  },
              ]
            : []),
    ];
