...
const DisbursalProcess = () => {
    ...
    const { data, isSuccess, refetch } = useAllocatedDisbursalsQuery({
    ...
    const columns = [
        ...
        ...(activeRole === "disbursalHead" || activeRole === "admin"
            ? [
                  {
                      field: "disbursalManagerId",
                      headerName: "Disbursal Manager",
                      width: 150,
                  },
              ]
            : []),
    ...
    const rows = disbursals?.map((disbursal) => ({
        ...
        ...((activeRole === "disbursalHead" || activeRole === "admin") && {
            disbursalManagerId: `${
                disbursal?.sanction?.application?.disbursalManagerId?.fName
            }${
                disbursal?.sanction?.application?.creditManagerId?.mName
                    ? ` ${disbursal?.sanction?.application?.creditManagerId?.mName}`
                    : ``
            } ${disbursal?.sanction?.application?.creditManagerId?.lName}`,
        }),
    }));
    ...
    return (
        <>
            <div className="crm-container">
                ...
                >
                    Total Applicattion: {totalDisbursals || 0}{" "}
