...
const NewApplications = () => {
    ...
    const [allocateApplication, { data: updateApplication, isSuccess }] =
        useAllocateApplicationMutation();
    ...
    const rows = applications?.applications?.map((application) => ({
        ...
        ...((activeRole === "sanctionHead" || activeRole === "admin") && {
            recommendedBy: `${application?.lead?.recommendedBy?.fName}${
                application?.lead?.recommendedBy?.mName
                    ? ` ${application?.lead?.recommendedBy?.mName}`
                    : ``
            } ${application?.lead?.recommendedBy?.lName}`,
        }),
    }));
    ...
    return (
        <>
            <div className="crm-container">
                ...
                >
                    Total Applicattion: {totalApplications || 0}{" "}
