...
const LeadProfile = () => {
    ...
    const {
        ...
        isError,
        error,
    } = useFetchSingleLeadQuery(id, { skip: id === null });
                            ...
                            <>
                                {currentPage === "verification" && (
                                    <VerifyContactDetails
                                        isMobileVerified={
                                            leadData?.isMobileVerified
                                        }
                                        isEmailVerified={
                                            leadData?.isEmailVerified
                                        }
                                        isAadhaarVerified={
                                            leadData?.isAadhaarVerified
                                        }
                                        isAadhaarDetailsSaved={
                                            leadData?.isAadhaarDetailsSaved
                                        }
