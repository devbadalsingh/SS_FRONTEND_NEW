...
const ProcessingLeads = () => {
    ...
    const { data, isSuccess, refetch } = useFetchAllocatedLeadsQuery({
        page: paginationModel.page + 1,
        limit: paginationModel.pageSize,
    });
    const { data: LeadData, isSuccess: leadSuccess } = useFetchSingleLeadQuery(
        id,
        { skip: id === null }
    );
    ...
    const rows = processingLeads?.leads?.map((lead) => ({
        ...
        source: lead?.source,
        ...((activeRole === "sanctionHead" || activeRole === "admin") && {
            screener: `${lead?.screenerId?.fName}${
    ...
    return (
        <>
            <div className="crm-container">
                ...
                >
                    Total Applicattion: {totalLeads || 0}{" "}
